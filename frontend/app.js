...
let S=JSON.parse(localStorage.getItem("duty_save"))||{balance:0,energy:5000,max_energy:5000,level:1,tap_power:1,referral_count:0,wallet:null};
...
setInterval(()=>{if(S.energy<S.max_energy){S.energy++;render()}},3000); // 1 energy / 3s, matches the backend regen rate
